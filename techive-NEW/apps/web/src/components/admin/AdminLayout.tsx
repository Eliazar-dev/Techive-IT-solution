...
import { LayoutDashboard, Briefcase, Layers, GraduationCap, FolderKanban, Users, FileText, Quote, Mail, Bell, Settings as SettingsIcon, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen bg-bg flex">
      <aside className="w-64 bg-white border-r border-border flex flex-col shrink-0">
        <div className="flex items-center gap-2 px-6 py-6 border-b border-border">
          <div className="bg-brand-gradient flex items-center justify-center rounded-[6px] size-7">
            <span className="font-heading font-extrabold text-sm text-white">T</span>
          </div>
